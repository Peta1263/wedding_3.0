...
const i18n = {
  sk: {
    ...
    sec_program: "Program",
    prog_arrival: "Príchod hostí do kostola",
    ...
    travel_airports_desc: "Najbližšie možnosti: Rimini, Bologna, Ancona alebo Benátky.",
    travel_hotels: "Odporúčané ubytovanie",
    travel_hotels_desc: "Sem vložíme hotely alebo apartmány, ktoré sú blízko miesta oslavy.",
  ...
  en: {
    ...
    prog_arrival: "Guests Arrival at the Church",
    ...
    travel_airports_desc: "Closest options: Rimini, Bologna, Ancona or Venice.",
    travel_hotels: "Recommended Accommodation",
    travel_hotels_desc: "We will list hotels or apartments close to the venue.",
  ...
  it: {
    ...
    prog_arrival: "Arrivo degli ospiti in chiesa",
    ...
    travel_airports_desc: "Le opzioni più vicine: Rimini, Bologna, Ancona o Venezia.",
    travel_hotels: "Alloggi consigliati",
    travel_hotels_desc: "Inseriremo hotel o appartamenti vicino alla location.",
